...
public class Platform {
	...
	public static void main(String[] args) {
		...
		/*Pel�culas cuya duraci�n sea menor a 120 minutos, que no sean del g�nero �comedia�.*/
		...
		//Pel�culas posteriores del 2017, a no ser que se trate de pel�culas del g�nero �infantil� o �documental�.
